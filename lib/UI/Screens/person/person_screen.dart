    ...
    return SafeArea(
      child: Scaffold(
        body: SingleChildScrollView(
            child: Consumer<PersonProvider>(builder: (context, provider, child) {
                                      ...
                                      Directionality(
                                          ...
                                          children: [
                                            Row(children: [
                                              ...
                                              Checkbox(
                                                  ...
                                                  activeColor:
                                                  ColorManager.orangeTxtColor,
                                                  value: PersonModelList.personModelList[i]
                                                      .personalHeadData!
                                                      .checkAge,
                                       ...
                                       PersonModelList.personModelList[i].personalHeadData!
                                                ...
                                                onChanged: (d) {
                                                  ...
                                                  provider.isEmployee(d.toString(), i);
                                               /*   setState(() {
                                                    if (d!.isNotEmpty) {
                                                      if (int.parse(
                                                          d.toString()) >
                                              ...
                                              PersonModelList.personModelList[i]
                                                  ...
                                                  true
                                                  ? DropDownFormInput2(
                                                label: PersonModelList.personModelList[i]
                                                    .personalHeadData!
                                                    .age
                                                    .text !=
                                                    ''
                                                    ? Text(PersonModelList.personModelList[i]
                                                    .personalHeadData!
                                                    .age
                                                    .text)
                                                    : const Text('إختار'),
                                                ...
                                                onChange: (String? p) {
                                                 /* PersonModelList.personModelList[i]
                                                  ...
                                                  provider.groupAgeKey(i, p.toString());
                                                },
                                              )
                                                  : Container(),
                                            ]),
                                   ...
                                   /* int x = int.parse(
                                    ...
                                    debugPrint(
                                        PersonModelList.personModelList.length
                                            .toString());
                                    PersonModelList.personModelList.length;
                                    if (10 > PersonModelList.personModelList
                                        .length) {
                                      setState(() {
                              ...
                              DefaultButton(
                                function: () {
                                  if (_key.currentState!.validate()) {
                                    ...
                                    CheckPersonValidation.validatePerson(
                                        context) ;
