...
import 'package:jaddah_household_survey/Data/HouseholdPart1/questions_data.dart';
...
class Q5 extends StatelessWidget{
  const Q5({super.key,required this.peopleAdults18,required this.peopleUnder18});
  ...
  Widget build(BuildContext context) {
    ...
    Row(mainAxisAlignment: MainAxisAlignment.end,children: [
      Row(children: [
        MyTextForm( label: "",controller: peopleUnder18,widthForm: width(context)*.07,),
        AppSize.spaceWidth1(context),
        TextGlobal(text:"children (under 18yrs)", fontSize: height(context)*.015 ,color: ColorManager.black,),

      ],),
      AppSize.spaceWidth3(context),
      Row(children: [
        MyTextForm( label: "",controller: peopleAdults18,widthForm: width(context)*.07,),
        AppSize.spaceWidth1(context),
      TextGlobal(text:"adults (18yrs +)", fontSize: height(context)*.017 ,color: ColorManager.grayColor,),
...
class Q6 extends StatefulWidget{
   Q6({super.key,required this.q6peopleAdults18,required this.q6peopleUnder18,required this.q6totalNumberOfVec});
  List<TextEditingController> q6peopleAdults18=<TextEditingController>[TextEditingController()];
  List<TextEditingController> q6peopleUnder18=<TextEditingController>[TextEditingController()];
  List<TextEditingController> q6totalNumberOfVec=<TextEditingController>[TextEditingController()];
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      for(int i=0;i<widget.q6peopleAdults18.length;i++)
        Column(children: [
          Field(peopleAdults18: widget.q6peopleAdults18[i],peopleUnder18Text: "children (under 18yrs)",peopleAdults18Text: "adults (18yrs +)" ,
              totalNumberOfVecText:"Total Number of Vehicles in each family" ,peopleUnder18: widget.q6peopleUnder18[i], totalNumberOfVec: widget.q6totalNumberOfVec[i]),
       AppSize.spaceHeight2(context),
        ],),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Field(peopleAdults18: editingController3.peopleAdults18, peopleUnder18: editingController3.peopleUnder18,
          totalNumberOfVecText: "Total number of bikes", totalNumberOfVec: editingController3.totalNumber,
          peopleAdults18Text: "adults (18yrs +)", peopleUnder18Text: "children (under 18yrs)")
...
class EditingController3 {
  ...
  EditingController3({required this.peopleUnder18,required this.totalNumber,required this.peopleAdults18});

}
class Field extends StatelessWidget{
  const Field({super.key,required this.peopleAdults18,required this.peopleUnder18,required this.totalNumberOfVecText,required this.totalNumberOfVec,required this.peopleAdults18Text,required this.peopleUnder18Text});
  final TextEditingController peopleAdults18 ;
  final TextEditingController peopleUnder18;
