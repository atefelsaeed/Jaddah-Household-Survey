...
class ActionSurveyProvider extends ChangeNotifier{
   q4(ChangeBoxResponse r,  List<TextEditingController> q6totalNumberOfVec, List<TextEditingController> q6peopleUnder18 ,  List<TextEditingController> q6peopleAdults18){
    if (r.check == true) {
