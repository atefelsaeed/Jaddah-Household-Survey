  ...
  getAllTripUpdated(BuildContext context) async {
    ...
    for (int i = 0; i < surveyPt.surveyPT!.tripsList!.length; i++) {
     ...
     print( surveyPt.surveyPT!.tripsList![i].tripReason);
      List value2 = purposeOfBeingThere[purposeOfBeingThere.keys.first].toList();

      for (int inr = 0; inr < value2.length; inr++) {
        if (surveyPt.surveyPT!.tripsList![i].tripReason ==value2[inr]["value"]) {
          purposeOfBeingThere[purposeOfBeingThere.keys.first].toList()[inr]["isChick"]=true;
          //  nationalityu.addAll(  {"value":  value2[inr]["value"], "isChick": true});
        }else{
          purposeOfBeingThere[purposeOfBeingThere.keys.first].toList()[inr]["isChick"]=false;
        }
        //  notifyListeners();
      }


      List value3 = purposeOfBeingThere2[purposeOfBeingThere2.keys.first].toList();
print("rrrrr");
print(surveyPt.surveyPT!.tripsList![i].purposeTravel );
      for (int inr = 0; inr < value3.length; inr++) {
        if (surveyPt.surveyPT!.tripsList![i].purposeTravel ==
            value3[inr]["value"]) {
          purposeOfBeingThere2[purposeOfBeingThere2.keys.first]
              .toList()[inr]["isChick"] = true;
          //  nationalityu.addAll(  {"value":  value2[inr]["value"], "isChick": true});
        } else {
          purposeOfBeingThere2[purposeOfBeingThere2.keys.first]
              .toList()[inr]["isChick"] = false;
        }
      }
      print("22");
      print(surveyPt.surveyPT!.tripsList![i].chosenPerson);
      TripModeList.tripModeList.add(
          TripsModel(person:  surveyPt.surveyPT!.tripsList![i].person,

              isHome: surveyPt.surveyPT!.tripsList![i].isHome, isHomeEnding:surveyPt.surveyPT!.tripsList![i].isHomeEnding,
              chosenFriendPerson:surveyPt.surveyPT!.tripsList![i].chosenFriendPerson,
              ...
              startBeginningModel: surveyPt.surveyPT!.tripsList![i].startBeginningModel,
hhsMembersTraveled: surveyPt.surveyPT!.tripsList![i].hhsMembersTraveled ,
              travelAloneHouseHold: surveyPt.surveyPT!.tripsList![i].travelAloneHouseHold,
              ...
              travelWithOtherModel: surveyPt.surveyPT!.tripsList![i].travelWithOtherModel,
              typeTravel: surveyPt.surveyPT!.tripsList![i].typeTravel,
              typeTravelCondition: surveyPt.surveyPT!.tripsList![i].typeTravelCondition,
              ...
              otherWhereDidYouParkEditingControl: surveyPt.surveyPT!.tripsList![i].otherWhereDidYouParkEditingControl,
              taxiTravelTypeEditingControl: surveyPt.surveyPT!.tripsList![i].taxiTravelTypeEditingControl,
  ...
  isTravelAlone(int index,ChangeBoxResponse r,BuildContext context){
    ...
    if (TripModeList
        .tripModeList[index].chosenPerson.isNotEmpty) {
      ...
      showDialog<void>(
        ...
        TripModeList
            .tripModeList[index]
            .travelWithOther[TripModeList.tripModeList[index]
            .travelWithOther.keys.first]!
            .toList()[
        TripModeList.tripModeList[index]
