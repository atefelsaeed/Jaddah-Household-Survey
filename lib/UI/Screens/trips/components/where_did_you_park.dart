...
class WhereDidYouPark extends StatefulWidget {
 ...
 final int index;
 const WhereDidYouPark ({super.key,required this.costTaxi,required this.index});
...
return Column(children: [
  ...
  Row(
    ...
    children: [
      ...
      TripModeList.tripModeList[widget.index].typeTravelCondition=="1"?   DropDownFormInput(
        ...
        TripData.whatTypeOfTaxi.keys.first]!
            .toList(),
        onChange: (String? p) {
          TripModeList.tripModeList[widget.index].typeTaxi=p.toString();
        },
      ):Container(),
      DropDownFormInput(
        ...
        TripData.whereDidYouPark.keys.first]!
            .toList(),
        onChange: (String? p) {
          TripModeList.tripModeList[widget.index].typeTravel=p.toString();
    List value = TripData
    ...
    setState(() {
      TripModeList.tripModeList[widget.index].typeTravelCondition =
    "1";
    });
  ...
  Directionality(
    ...
    child: Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        TripModeList.tripModeList[widget.index].typeTravelCondition=="1"?    TextForm(
